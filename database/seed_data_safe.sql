-- ============================================
-- DONNÉES COMPLÈTES POUR LE QUIZ (VERSION SÉCURISÉE)
-- ============================================
...
-- ============================================
-- Décommentez les lignes suivantes si vous voulez réinitialiser les données
...
DELETE FROM options WHERE question_id IN (SELECT id FROM questions);
DELETE FROM questions;
...
-- ============================================
-- Supprimer les métiers existants pour éviter les doublons
DELETE FROM jobs;
...
-- - 5 profils (déjà existants, donc pas d'erreur)
-- - 12 questions
