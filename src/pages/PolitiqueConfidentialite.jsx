...
function PolitiqueConfidentialite() {
  ...
  const content = {
    fr: {
      ...
      section6: {
        title: "6. Cookies",
        content: "Le site quizorientation.online utilise des cookies pour améliorer votre expérience de navigation. Les cookies sont de petits fichiers texte stockés sur votre appareil. Nous utilisons des cookies techniques nécessaires au fonctionnement du site, des cookies analytiques pour comprendre comment les visiteurs utilisent notre site, et des cookies de préférences pour mémoriser vos choix (comme la langue sélectionnée). Vous pouvez configurer votre navigateur pour refuser les cookies, mais cela peut affecter certaines fonctionnalités du site."
      },
    ...
    en: {
      ...
      section6: { title: "6. Cookies", content: "The quizorientation.online website uses cookies to improve your browsing experience. We use technical cookies necessary for the site's operation, analytical cookies to understand how visitors use our site, and preference cookies to remember your choices (such as the selected language)." },
    ...
    ar: {
      ...
      section6: { title: "6. ملفات تعريف الارتباط", content: "يستخدم موقع quizorientation.online ملفات تعريف الارتباط لتحسين تجربة التصفح الخاصة بك. نستخدم ملفات تعريف الارتباط التقنية الضرورية لتشغيل الموقع وملفات تعريف الارتباط التحليلية لفهم كيفية استخدام الزوار لموقعنا." },
