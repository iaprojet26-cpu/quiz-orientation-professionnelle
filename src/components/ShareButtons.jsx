...
function ShareButtons({ results }) {
  ...
  const shareMessage = t('share.message', { profile: results?.profile?.nom || '' })
    ...
    <div>
      ...
      <div className="flex flex-wrap justify-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-sky-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-sky-600 transition-colors shadow-md"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
